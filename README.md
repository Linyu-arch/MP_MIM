...
MP-MIM can run on Linux and Windows. The package has been tested on the Linux system.

### Python Dependencies: 

MP-MIM mainly depends on the Python (3.6+) scientific stack. (Recommended) Use python virutal environment with conda.
...
We take an example of an analysis when k_num is 90 and l_num is 15 in MP-MIM. Here we use parameters to demo purposes:
