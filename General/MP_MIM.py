...
parser.add_argument('--MP-type', type=str, default='Distance_based_GCN', help='the type of message passing, Distance_based_GCN or Basic_GCN can be used. (default: Distance_based_GCN)')
