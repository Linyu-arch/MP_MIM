...
def save_transformed_RGB_to_image_and_csv(spot_row_in_fullres,
    ...
    for index in range(len(X_transformed)):
        ...
        cv2.rectangle(img, (int(spot_col_in_fullres[index] - plot_spot_radius),int(spot_row_in_fullres[index] - plot_spot_radius)),
                      (int(spot_col_in_fullres[index] + plot_spot_radius),int( spot_row_in_fullres[index]+ plot_spot_radius)),
