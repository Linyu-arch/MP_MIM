...
- ***_embedding_ground_truth_rank.csv**:    Quality representation of each embedding is shown in the ground truth ranking. 

- ***_MP_MIM.csv**:    Final Moran's I with max filtering evaluation of each embedding.

- ***_embedding.csv**:    Native embedding generated by RESEPT.

- ***_graph_embedding**:    Transformed embedding generated by MP-MIM based on message passing.
