...
if __name__ == '__main__':
    ...
    embedding, y_pred, prob = generate_spagcn_output(adata, pca=50, res=0.4,dim = 50, img_path=optical_img_path, pca_opt=pca_opt, sample=sample, cluster_num = cluster_num)         #add kmeans
