...
parser = argparse.ArgumentParser(description='Native SpaGCN')
...
if __name__ == '__main__':
    ...
    #---------------------------------------------kmeans_clusters-------------------------------------------#
    if sample == '151507' or sample == '151508' or sample == '151509' or sample == '151510' or sample == '151673' or sample == '151674' or sample == '151675' or sample == '151676' or sample == '2-5' or sample == '18-64' or sample == 'T4857':
        cluster_num = 7
    if sample == '151669' or sample == '151670' or sample == '151671' or sample == '151672':
        cluster_num = 5
    if sample == '2-8':
        cluster_num = 6
    print('cluster num is '+ str(cluster_num))
    
    #--------------------------------------------------------------------------------------------------------#
    # -------------------------------calculate_ARI--------------------------------------------------#
    adata_barcode_list = adata.obs.index.tolist()
    embedding, y_pred, prob = generate_spagcn_output(adata, pca=50, res=0.4,dim = 50, img_path=optical_img_path, pca_opt=pca_opt, cluster_num = cluster_num)         #add kmeans
